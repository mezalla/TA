							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Crawling Tweet</h5>
										<!--end::Page Title-->
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<div class="alert-text">Proses crawling tersebut
                                        menggunakan library tweepy dari bahasa pemrograman Python, library ini
                                        berfungsi untuk mengambil data tweet pada Twitter dengan menggunakan
                                        API Key yang didapatkan dari akun developer twitter.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
								<div class="card card-custom gutter-b">
									<div class="card-header flex-wrap py-3">
										<div class="card-title">
											<h3 class="card-label">Crawling Tweet
											<span class="d-block text-muted pt-2 font-size-sm">Berikut adalah data crawling yang sudah tersimpan</span></h3>
										</div>
										<div class="card-toolbar">
											...
											<div class="dropdown dropdown-inline mr-2">
												...
												<span class="svg-icon svg-icon-md">
													<!--begin::Svg Icon | path:/metronic/theme/html/demo7/dist/assets/media/svg/icons/Design/PenAndRuller.svg-->
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															<rect x="0" y="0" width="24" height="24" />
									...
									<div class="card-body">
										...
										<table class="table table-bordered" id="kt_datatable">
											...
											<tbody>
                                                <?php $no = 1; foreach ( $tweepy->result_array() AS $row ) : ?>
                                                    <tr>
                                                        <td><?php echo $no ?></td>
