...
<html lang="en">
	...
	<head>
		...
		<link href="<?php echo base_url() ?>/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.2.8" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed header-bottom-enabled page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile bg-primary header-mobile-fixed">
			...
			<a href="/metronic/demo7/index.html">
				<img alt="Logo" src="http://www.budiluhur.ac.id/wp-content/uploads/2011/08/logo-bl-cakti.png" class="max-h-30px" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
			<div class="d-flex align-items-center">
				...
				<button class="btn p-0 ml-2" id="kt_header_mobile_topbar_toggle">
					<span class="svg-icon svg-icon-xl">
						<!--begin::Svg Icon | path:<?php echo base_url() ?>/dist/assets/media/svg/icons/General/User.svg-->
							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<a href="/metronic/demo7/index.html" class="mr-20">
										<img alt="Logo" src="http://www.budiluhur.ac.id/wp-content/uploads/2011/08/logo-bl-cakti.png" class="max-h-55px" />
									</a>
									<!--end::Logo-->
								</div>
								<!--end::Left-->
									...
									<div class="topbar-item">
										<div class="btn btn-icon btn-hover-transparent-white w-sm-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
											<div class="d-flex flex-column text-right pr-sm-3">
												<span class="text-white opacity-50 font-weight-bold font-size-sm d-none d-sm-inline">Universitas Budi Luhur</span>
												<span class="text-white font-weight-bolder font-size-sm d-none d-sm-inline">Mellanuri Adzanmah</span>
											</div>
											<span class="symbol symbol-35">
												<span class="symbol-label font-size-h5 font-weight-bold text-white bg-white-o-30">MA</span>
											</span>
										</div>
									</div>
									<!--end::User-->
