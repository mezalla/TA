							...
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Preprocessing</h5>
										<!--end::Page Title-->
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
									...
									<div class="alert-text">ada tahap preprocessing, dilakukan beberapa prosses yang bertujuan untuk pembersihan data agar dapat memudahkan selanjutnya.</div>
								</div>
								<!--end::Notice-->
								<!--begin::Card-->
								<div class="row">
                                        ...
                                        <div class="card card-custom gutter-b">
                                            <div class="card-header flex-wrap py-3">
                                                <div class="card-title">
                                                    <h3 class="card-label">Opsi
                                                    <span class="d-block text-muted pt-2 font-size-sm">Pilih opsi dibawah ini</span></h3>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form action="" method="GET">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="">Pembagian Data Training dan Testing</label>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="number" name="training" class="form-control" placeholder="Training . . ." value="<?php echo $train ?>" />
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="number" name="testing" class="form-control" placeholder="Testing . . ." value="<?php echo $testing ?>" />
                                                            </div>
                                                        </div>
                                                        <small>Masukkan pembagian datatraining dan testing</small>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="">Threshold</label>
                                                        <input type="number" name="threshold" class="form-control" placeholder="Masukkan nilai presetanse threshold . . ." required="" value="<?php echo $threshold ?>" />
                                                    </div>


                                                    <div class="form-group">
                                                        <button class="btn btn-primary">Klasifikasi</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card card-custom gutter-b">
                                            ...
                                            <div class="card-body">
                                                ...
                                                if ( $this->input->get('training') ) { ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <h1><?php echo number_format($klasifikasi['accuracy'], 2) ?>%</h1>  
                                                            <label>Nilai Akurasi</label>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <h1><?php echo number_format($klasifikasi['precision'], 2) ?>%</h1>  
                                                            <label>Nilai Precision</label>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <h1><?php echo number_format($klasifikasi['recall'], 2) ?>%</h1>  
                                                            <label>Nilai Recall </label>
                                                        </div>
                                                    </div>
                                                    <small>Nilai Confusion Matrix dengan Threshold <?php echo $threshold ?>%</small>
                                                    <hr>
                                                <?php } ?>
                                                <!--begin: Datatable-->
                                                <table class="table table-bordered" id="kt_datatable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['label'] == "true" ? label( "True", "success" ) : label( "Fake", "danger" ) ?></td>
                                                            <td><?php echo $row['prediksi'] == "true" ? label( "True", "success" ) : label( "Fake", "danger" ) ?></td>
                                                        </tr>
                                                        <?php endforeach; } ?>
                                                    </tbody>
                                                </table>
					...
					<?php
                        ...
                        function label( $text, $color ) {
                            ...
                            return '<span class="label label-inline label-light-'.$color.' font-weight-bold">
                                    '.$text.'
                                </span>';
                        }
